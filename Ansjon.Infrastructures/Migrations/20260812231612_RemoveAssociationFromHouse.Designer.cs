...
namespace Ansjon.Infrastructures.Migrations
{
    ...
    [Migration("20260812231612_RemoveAssociationFromHouse")]
    partial class RemoveAssociationFromHouse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ansjon.Core.Aggregates.Houses.Tenants.Tenant", b =>
                {
                    ...
                    b.OwnsOne("Ansjon.Core.SharedKernel.ValuesObjects.Name", "FirstName", b1 =>
                        {
                    ...
                    b.OwnsOne("Ansjon.Core.SharedKernel.ValuesObjects.Name", "LastName", b1 =>
                        {
                            b1.Property<Guid>("TenantId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Ansjon.Core.SharedKernel.ValuesObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("TenantId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Ansjon.Core.SharedKernel.ValuesObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<Guid>("TenantId")
                                .HasColumnType("uniqueidentifier");
